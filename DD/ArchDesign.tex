...
The only difference is that the regular check of the privacy costraint is done before retrieving the data, through the DBMS. Indeed, the DB containts he list of all the individuals whose data is accessible by each third party.\\ 
