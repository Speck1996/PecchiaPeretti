...
\begin{tabular}{|l|p{11cm}|}
    ...
    \end{enumerate}
    All the exceptions above are notified to the individual who is taken back to the registraton form.
      \\
    \hline
\end{tabular}
...
\begin{tabular}{|l|p{11cm}|}
    ...
    \end{enumerate}
     \\ \hline
     Exit Condition & Third party credenials have successfully been added to the system,
    ...
    \end{enumerate}
    All the exceptions above are notified to the third party who is taken back to the registraton form.
      \\
    \hline
\end{tabular}
