...
\item Location Services: these services will be used to translate the geographical filters applied by third parties to coordinates, that will be used to filter the requested data in the database.
\end{itemize}
...
At beginning, the only initially supported smartwatches will be wearOS smartwatches.
...
\subsection{Security}
Users passwords will be encrypted as soon as they are inserted in the applications.
