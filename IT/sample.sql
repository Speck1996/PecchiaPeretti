...
INSERT INTO Monitoring (individual, third_party, views)
	VALUES	('ABCDE', 'mydoc', 5);

INSERT INTO GroupMonitoring (third_party, views, location, age_min, age_max, sex)
	VALUES ('cardiologist', 3, 'Milano', '18', '35', 'female');

INSERT INTO HeartBeat (individual, ts, value, location)
...
INSERT INTO SleepTime (individual, day, value, location)
