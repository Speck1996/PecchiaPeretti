...
@NamedQueries({
        @NamedQuery(name = "BloodPressure.requestAnonymized",
                query = "SELECT b FROM IndividualEntity i, BloodPressureEntity b WHERE i = b.individual and i.country like :country and b.id.ts <= :lastupdate and b.id.ts <= :lastupdate  ORDER BY b.id.ts DESC"),
        @NamedQuery(name = "BloodPressure.requestLocationAnonymized",
                query = "SELECT b FROM IndividualEntity i, BloodPressureEntity b WHERE i = b.individual and i.country like :country and b.latitude >= :minlat and b.latitude <= :maxlat and b.longitude >= :minlong and b.longitude <= :maxlong and b.id.ts <= :lastupdate and b.id.ts <= :lastupdate  ORDER BY b.id.ts DESC"),
        @NamedQuery(name = "BloodPressure.requestDateAnonymized",
                query = "SELECT b FROM IndividualEntity i, BloodPressureEntity b WHERE i = b.individual and i.birthDate >= :datemin and i.birthDate <= :datemax and i.country like :country and b.id.ts <= :lastupdate  and b.id.ts <= :lastupdate  ORDER BY b.id.ts DESC"),
        @NamedQuery(name = "BloodPressure.requestLocationDateAnonymized",
                query = "SELECT b FROM IndividualEntity i, BloodPressureEntity b WHERE i = b.individual and i.birthDate >= :datemin and i.birthDate <= :datemax and i.country like :country and b.latitude >= :minlat and b.latitude <= :maxlat and b.longitude >= :minlong and b.longitude <= :maxlong and b.id.ts <= :lastupdate and b.id.ts <= :lastupdate   ORDER BY b.id.ts DESC"),
        @NamedQuery(name = "BloodPressure.requestSexAnonymized",
                query = "SELECT b FROM IndividualEntity i, BloodPressureEntity b WHERE i = b.individual and i.country like :country and i.sex = :sex and b.id.ts <= :lastupdate  and b.id.ts <= :lastupdate  ORDER BY b.id.ts DESC"),
        @NamedQuery(name = "BloodPressure.requestLocationSexAnonymized",
                query = "SELECT b FROM IndividualEntity i, BloodPressureEntity b WHERE i = b.individual and i.country like :country and i.sex = :sex and b.latitude >= :minlat and b.latitude <= :maxlat and b.longitude >= :minlong and b.longitude <= :maxlong and b.id.ts <= :lastupdate  and b.id.ts <= :lastupdate  ORDER BY b.id.ts DESC"),
        @NamedQuery(name = "BloodPressure.requestDateSexAnonymized",
                query = "SELECT b FROM IndividualEntity i, BloodPressureEntity b WHERE i = b.individual and i.birthDate >= :datemin and i.birthDate <= :datemax and i.country like :country and i.sex = :sex and b.latitude >= :minlat and b.latitude <= :maxlat and b.longitude >= :minlong and b.longitude <= :maxlong  and b.id.ts <= :lastupdate ORDER BY b.id.ts DESC"),
