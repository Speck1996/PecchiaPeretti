...
@NamedQueries({
        ...
        @NamedQuery(name = "BloodPressure.requestDateSexAnonymized",
                query = "SELECT b FROM IndividualEntity i, BloodPressureEntity b WHERE i = b.individual and i.birthDate >= :datemin and i.birthDate <= :datemax and i.country like :country and i.sex = :sex ORDER BY b.id.ts DESC"),
...
//    }
     ...
     */
    public void setValueMin(short value) {
        this.valueMin = value;
    }
